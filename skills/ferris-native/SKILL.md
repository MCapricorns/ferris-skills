---
name: ferris-native
description: Use when changing C++/Rust ownership, unsafe code, FFI, async cancellation, or build configuration, or diagnosing C++/Rust compiler, linker, Cargo, or MSBuild failures.
---
